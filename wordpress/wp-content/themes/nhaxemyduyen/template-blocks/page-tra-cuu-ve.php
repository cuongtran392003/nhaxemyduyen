    ...
    <section>
        ...
        <section class="flex flex-col items-center gap-y-5 mb-5">
            <div class="xl:mb-[32px]">
                ...
                xl:text-43 xl:mt-[73px] xl:mb-[32px]">Kiểm tra thông tin vé</h1>
            ...
            <section class="flex flex-col items-center gap-y-2 font-poppins">
                ...
                xl:flex-row xl:gap-x-5">
                    <div class="flex flex-col gap-y-2 font-poppins text-sm
                                    xl:text-14">
                        <p class="text-red-custom">Mã vé</p>
                ...
                xl:w-[278px] xl:h-[68px]">Kiểm tra vé</button>
            </section>

            <div class="flex flex-row gap-x-5 xl:gap-x-[186px]">
                <div class="flex flex-col gap-y-5 text-sm font-poppins xl:text-14">
                    <p class="text-red-custom">Bước 1: Nhập thông tin vé</p>
                    <img src="<?php echo get_template_directory_uri(); ?>/nhaxemyduyen/assets/image/kiemtra.png" alt="" class="w-40 xl:w-[369px] xl:h-[401px]">
                </div>
                <div class="flex flex-col gap-y-5 text-sm font-poppins xl:text-14">
                    <p class="text-red-custom">Bước 2: Kiểm tra vé</p>
                    <img src="<?php echo get_template_directory_uri(); ?>/nhaxemyduyen/assets/image/kiemtra.png" alt="" class="w-40 xl:w-[369px] xl:h-[401px]">
                </div>
            </div>
        </section>
